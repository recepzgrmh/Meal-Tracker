...
const tr: Record<string, string> = {
  ...
  'Production food catalog': 'Production gıda kataloğu',
  'The mobile application uses the validated Supabase 60K catalog.': 'Mobil uygulama doğrulanmış Supabase 60K kataloğunu kullanır.',
  'Runtime source': 'Çalışma zamanı kaynağı', 'Provider switching is disabled; production has one deterministic catalog.': 'Sağlayıcı geçişi kapalıdır; production tek bir deterministic katalog kullanır.',
  'Catalog version': 'Katalog sürümü', 'Food records': 'Gıda kayıtları', 'Macro-complete records': 'Makroları eksiksiz kayıtlar',
  'Search aliases': 'Arama alias kayıtları', 'Portion records': 'Porsiyon kayıtları',
  'Production catalog status is not available.': 'Production katalog durumu kullanılamıyor.',
  'Food Catalog': 'Gıda Kataloğu',
  'Browse the validated 60K Supabase production catalog without loading it into the browser.': 'Doğrulanmış 60K Supabase production kataloğunu tarayıcıya yüklemeden incele.',
  'Production foods': 'Production gıdaları', 'Macro complete': 'Makroları eksiksiz',
  'kcal + protein + carbs + fat': 'kcal + protein + karbonhidrat + yağ', 'Turkish + English': 'Türkçe + İngilizce',
  'Filter food catalog': 'Gıda kataloğunu filtrele', 'Search foods': 'Gıdalarda ara',
  'Search name, alias, brand or barcode…': 'İsim, alias, marka veya barkod ara…',
  'Food type': 'Gıda türü', 'All foods': 'Tüm gıdalar', 'Generic': 'Generic', 'Branded': 'Markalı',
  'Selection tier': 'Seçim katmanı', 'All tiers': 'Tüm katmanlar',
  'Catalog could not be loaded': 'Katalog yüklenemedi', 'Check the production connection and try again.': 'Production bağlantısını kontrol edip yeniden dene.',
  'No foods match these filters': 'Bu filtrelerle eşleşen gıda yok', 'Try a broader query or reset the filters.': 'Daha geniş bir arama yap veya filtreleri sıfırla.',
  'Food': 'Gıda', 'Brand': 'Marka', 'Category': 'Kategori', 'Tier': 'Katman',
  'Protein': 'Protein', 'Carbs': 'Karbonhidrat', 'Fat': 'Yağ', 'Portions': 'Porsiyonlar',
  'Food details': 'Gıda detayları', 'Food details could not be loaded': 'Gıda detayları yüklenemedi',
  'Nutrition per 100 g': '100 g için besin değerleri', 'Calories': 'Kalori',
  'Identity and provenance': 'Kimlik ve provenance', 'Barcode': 'Barkod', 'Dataset version': 'Dataset sürümü',
  'Canonical ID': 'Canonical ID', 'Inclusion reasons': 'Dahil edilme nedenleri', 'Aliases': 'Aliaslar',
  'AI Evals': 'AI Değerlendirmeleri',
  'Gold-set results the eval runners persisted, run over run.': 'Değerlendirme koşularının kaydettiği altın set sonuçları, koşudan koşuya.',
  'No eval results stored yet': 'Henüz kayıtlı değerlendirme sonucu yok',
  'Run `deno task eval -- --persist`, or the live eval with service credentials, and results land here.': 'Sonuçların burada görünmesi için `deno task eval -- --persist` komutunu veya servis kimlik bilgileriyle canlı değerlendirmeyi çalıştır.',
  'Kind': 'Tür', 'Suite': 'Set', 'Pass rate': 'Geçme oranı', 'Headline metrics': 'Öne çıkan metrikler',
  'deterministic': 'deterministik', 'live': 'canlı', 'Cost': 'Maliyet',
  'Latest pass rate': 'Son geçme oranı', 'Latest headline': 'Son öne çıkanlar',
  'Recorded eval spend': 'Kayıtlı değerlendirme maliyeti', 'live runs only': 'yalnızca canlı koşular',
  'Select a run to review its failed cases': 'Başarısız vakalarını incelemek için bir koşu seç',
  'Eval run': 'Değerlendirme koşusu', 'Git ref': 'Git referansı', 'Notes': 'Notlar',
  'Started': 'Başlangıç', 'Completed': 'Bitiş', 'Report metrics': 'Rapor metrikleri',
  'Failed cases': 'Başarısız vakalar', 'Eval cases could not be loaded': 'Değerlendirme vakaları yüklenemedi',
  'All cases passed': 'Tüm vakalar geçti', 'Nothing to triage in this run.': 'Bu koşuda incelenecek bir şey yok.',
  'Expected': 'Beklenen', 'Actual': 'Gerçekleşen',
}
