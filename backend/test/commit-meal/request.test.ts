...
import { CommitRequestValidationError, parseCommitMealRequest } from '../../src/routes/commit-meal/request.ts'
...
test('accepts and normalizes a grounded commit request', () => {
...
test('rejects forged nutrition and unknown fields', () => {
  expectValidation(() =>
...
test('accepts an estimate-backed item and enforces food/estimate exclusivity', () => {
...
test('rejects duplicate keys and invalid grams', () => {
  expectValidation(() =>
