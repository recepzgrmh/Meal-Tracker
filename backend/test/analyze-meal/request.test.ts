...
import { parseAnalyzeMealRequest, RequestValidationError } from '../../src/routes/analyze-meal/request.ts'

test('accepts text in Turkish and English', () => {
...
test('accepts private photo and mixed contracts', () => {
  const photo = {
    bucket: 'meal-photos',
...
test('rejects a forged user id and unknown fields', () => {
...
test('rejects invalid ids, incomplete input kinds, and unsupported locale', () => {
